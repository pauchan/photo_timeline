...
sys.path.append(os.path.dirname('/Users/pawelrusin/Devel/DeepLearning/MokuMoku'))
print sys.path
import timeline_dataset
...
if __name__ == "__main__":
    ...
    train = timeline_dataset.Timeliner(which_set="train")
...
#    train_example_path = os.path.join(path, 'scripts', 'tutorials', 'grbm_smd')
    ...
    train.use_design_loc('/Users/pawelrusin/Devel//DeepLearning/MokuMoku/timeliner_preprocessed_train_design.npy')

    #train_pkl_path = os.path.join('timeliner_preprocessed_train.pkl')
    serial.save('/Users/pawelrusin/Devel/DeepLearning/MokuMoku/timeliner_preprocessed_train.pkl', train)
